...
def main(args):
    ...
    if args.state_only:
        encoder = Con_Net(args.network)

        encoder_trans = Adjust_Trans(n_layers=args.n_layers, feature_size=[args.feat_size, args.feat_size, args.encoder_dim])


        decoder =LightDecoderGenerator(encoder_dim=args.encoder_dim, feature_dim=args.feature_dim, vocab_size=len(word_vocab),
                                    max_lengths=args.max_length, word_vocab=word_vocab, n_head=args.n_heads,
                                    n_layers=args.decoder_n_layers, dropout=args.dropout)

        encoder.load_state_dict(checkpoint['extractor_dict'])
        encoder_trans.load_state_dict(checkpoint['encoder_dict'])
        decoder.load_state_dict(checkpoint['generator_dict'])
    else:
        encoder = checkpoint['extractor']
        encoder_trans = checkpoint['encoder']
        decoder = checkpoint['generator']
    ...
    if args.data_name == 'LEVIR_CC':
        ...
        test_loader = data.DataLoader(
            LEVIR_CC_Dataset(data_path=args.data_folder, list_path=args.list_path, split='test', token_folder=args.token_folder,
                             vocab_file=args.vocab_file, max_length=args.max_length, allow_unknown=args.allow_unk),
        ...
        test_loader = data.DataLoader(
            DubaiCCDataset(args.data_folder, args.list_path, 'test', args.token_folder, args.vocab_file, args.max_length,
                           args.allow_unk),
            batch_size=args.test_batchsize, shuffle=False, num_workers=args.workers, pin_memory=True)
...
if __name__ == '__main__':
    ...
    # For LEVIR_CC
    parser.add_argument('--data_folder', default='/home/sdw/paper_projects/Lite_Chag2cap/data/LEVIR_CC/images',
                        help='folder with data files')
    parser.add_argument('--list_path', default='/home/sdw/paper_projects/Lite_Chag2cap/data/LEVIR_CC/',
                        help='path of the data lists')
    parser.add_argument('--token_folder', default='/home/sdw/paper_projects/Lite_Chag2cap/data/LEVIR_CC/tokens/',
    ...
    #                     default='/home/sdw/paper_projects/Lite_Chag2cap/checkpoints/LEVIR_CC_BatchSize_32_resnet101_Bleu-4_6414.pth',
    #                     help='path to checkpoint, None if none.')

    parser.add_argument('--checkpoint',
                        default='/home/sdw/paper_projects/Lite_Chag2cap/checkpoints/LEVIR_CC_BatchSize_32_vgg_Bleu-4_5758_1_1024test.pth',
                        help='path to checkpoint, None if none.')
    ...
    parser.add_argument('--encoder_dim', default=2048,
    ...
    parser.add_argument('--state_only', type=bool, default=False, help='whether to save model.state_dict only'
                                                                       'when training')
    # For dataset dubai-CC

    # parser.add_argument('--data_folder', default='/home/sdw/paper_projects/Lite_Chag2cap/data/Dubai_CC/images',
    #                     help='folder with data files')
    # parser.add_argument('--list_path', default='/home/sdw/paper_projects/Lite_Chag2cap/data/Dubai_CC/',
    #                     help='path of the data lists')
    # parser.add_argument('--token_folder', default='/home/sdw/paper_projects/Lite_Chag2cap/data/Dubai_CC/tokens/',
    #                     help='folder with token files')
    # # parser.add_argument('--vocab_file', default='vocab', help='path of the data lists')
    ...
    # parser.add_argument('--checkpoint', default='/home/sdw/paper_projects/Lite_Chag2cap/checkpoints/Dubai_CC_BatchSize_32_resnet101_Bleu-4_4948_1.pth',
    #                     help='path to checkpoint, None if none.')
